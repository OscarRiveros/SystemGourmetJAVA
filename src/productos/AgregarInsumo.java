...
void verproducto(){
        try{
            ...
            ResultSet rs = consultamarca.executeQuery("select * from productos where tipo='insumo'");
...
//            modelo.addColumn("Categoria");
     ...
     public void cargarproducto(String valor ){
        ...
        String sql=null;
         ...
         sql+=" from productos ";
         sql+=" where tipo='insumo' order by idproducto";
...
//           Integer descripcion = Integer.parseInt(tablaIngredientesDos.getValueAt(c, 1).toString());
       ...
       if(txtCantidad.getText().isEmpty()){
        ...
        try {
            ...
            Logger.getLogger(AgregarInsumo.class.getName()).log(Level.SEVERE, null, ex);
        }
      }
    ...
    private void initComponents() {
        ...
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 430, -1, -1));
        ...
        jPanel2.add(txtPrecioCompra, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 430, 110, -1));
        ...
        jPanel2.add(comboCategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 350, 130, -1));
        ...
        jPanel2.add(txtBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 10, 200, 30));
        ...
        jPanel2.add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(650, 10, 110, 30));
        ...
        jLabel5.setText("Introduzca Descripcion del Insumo");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 20, 210, -1));

        jLabel7.setText("Unidada de Medida:");
        ...
        jPanel2.add(jcboMedida, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 390, 130, -1));

        cboTipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "insumo" }));
        ...
        btnInforme.setText("Imprimir Lista");
        btnInforme.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnInformeActionPerformed(evt);
            }
        });
        jPanel2.add(btnInforme, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 20, -1, -1));
...
//                Statement  st;
    ...
    private void btnInformeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInformeActionPerformed
        // TODO add your handling code here:
         jasper.runReporte("/src/reportes/Insumos.jasper");
